...
**JPN225 3d OHLCV index historical data** — ultra high-quality 3d OHLCV for **Nikkei 225**. Clean `time, open, high, low, close, volume` CSV for backtesting, algorithmic trading and quantitative research.
...
> **Sample on GitHub** · `JPN225_3d.csv` (19 rows, `2026-07-09` -> `2026-09-01`, 1.40 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/jpn225)** — **6,261** `3d` rows (full `1m`: 5,192,657), **11 timeframes**, `1970-02-12` -> `2026-09-01`.
...
| 3d rows | 19 | **6,261** |
| Size | 1.40 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/jpn225) |
| Period | `2026-07-09` -> `2026-09-01` | `1970-02-12` -> `2026-09-01` |
...
| 2026-07-21T00:00:00+00:00 | 67215.81 | 67657.22 | 64213.01 | 64360.01 | 711712 |
...
df = pd.read_csv('JPN225_3d.csv', parse_dates=['time'])
